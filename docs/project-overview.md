...
```
db-ml-end-to-end        <- Root directory. Both monorepo and polyrepo are supported.
│
├── db_ml_end_to_end       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
