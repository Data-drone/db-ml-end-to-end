...
[ML Config](../db_ml_end_to_end/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore db_ml_end_to_end/resources/README.md
...
Follow the instructions in [db-ml-end-to-end/resources/README.md](../db_ml_end_to_end/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../db_ml_end_to_end/resources/README.md)  to propose, test, and deploy
