...
# ``db_ml_end_to_end/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-db-ml-end-to-end-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.my-mlops-project.db-ml-end-to-end-model", label="Full (Three-Level) Model Name"
)
