...
Opening a pull request will trigger a[workflow](../.github/workflows/db-ml-end-to-end-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/staging-db-ml-end-to-end-model)
* [Prod workspace registered model](https://e2-demo-field-eng.cloud.databricks.com#mlflow/models/prod-db-ml-end-to-end-model)
